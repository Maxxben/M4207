 ...
 */
final class Version20210310180410 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE acces (id INT AUTO_INCREMENT NOT NULL, utilisateurid_id INT DEFAULT NULL, documentid_id INT DEFAULT NULL, autorisation_id INT DEFAULT NULL, INDEX IDX_D0F43B10EBE08276 (utilisateurid_id), INDEX IDX_D0F43B1085D562DF (documentid_id), INDEX IDX_D0F43B1052C5E836 (autorisation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
